export namespace TradeTradeGet {
  ...
  export interface Response {
     ...
     * 订单优惠详情结构体
     */
    order_promotion?: StructurizationTradePromotionInfoDetail;
  }
  ...
  * 1:买家已经申请退款，等待卖家同意;  10:卖家拒绝退款;  20:卖家已经同意退货，等待买家退货;  30:买家已经退货，等待卖家确认收货;  40:卖家未收到货,拒绝退款;  50:退款关闭;  60:退款成功;
   ...
   * 退款交易明细信息
   */
  export interface StructurizationTradeRefundItemDetail {
    /**
     * 交易明细id
     */
    oid?: string;
  ...
  * 0:手动发货; 1:系统自动发货
   ...
   * 交易明细发货信息
   */
  export interface StructurizationTradeDeliveryItemDetail {
    /**
     * 交易明细id
     */
    oid?: string;
   ...
   * 物流包裹详情
   */
  export interface StructurizationTradeDeliveryDist {
    /**
     * 包裹id
     */
    dist_id?: string;
     ...
     * 包裹物流详情
     */
    express_info?: StructurizationTradeDeliveryExpressInfo;
  }

  /**
   * 包裹物流详情
   */
  export interface StructurizationTradeDeliveryExpressInfo {
    /**
     * 物流类型
     */
    express_id?: number;
   ...
   * 订单优惠详情结构体
   */
  export interface StructurizationTradePromotionInfoDetail {
    /**
     * 订单商品级优惠结构结构体
     */
     ...
     * 商品优惠总金额
     */
    item_discount_fee?: string;
    /**
     * 订单优惠总金额
     */
    order_discount_fee?: string;
    /**
     * 订单改价金额
     */
    adjust_fee?: string;
   ...
   * 订单商品级优惠结构结构体
   */
  export interface StructurizationTradePromotionItemDetail {
    /**
     * 是否赠品
     */
    is_present?: boolean;
