...
export namespace StoredValueCardCardvoucherValuecardPayRcdBypubSearch {
  /**
   * 请求参数
   */
  ...
  export interface Response {
     ...
     * 实体信息
     */
    items?: PageQueryPayLogByPublishKdtIdDTO[];
  }
   ...
   * 实体信息
   */
  export interface PageQueryPayLogByPublishKdtIdDTO {
    /**
     * 发卡机构的店铺Id
     */
    kdt_id?: number;
