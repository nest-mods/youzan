export namespace StoredValueCardCardvoucherValuecardRechgRcdBypubSearch {
  /**
   * 请求参数
   */
  ...
  export interface Response {
     ...
     * 实体信息
     */
    items?: PageQueryRechargeLogByPublishKdtIdDTO[];
    /**
     * 分页信息
     */
   ...
   * 实体信息
   */
  export interface PageQueryRechargeLogByPublishKdtIdDTO {
    /**
     * 发卡机构的店铺Id
     */
    kdt_id?: number;
